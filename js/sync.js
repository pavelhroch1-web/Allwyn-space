...
const SYNC_GLOBAL_KEYS = ['admin_tasks','editor_briefing','editor_alert','editor_idt','editor_ka','editor_campaigns','inv_catalog','editor_task_templates','editor_merch_items','editor_checklist_templates','editor_refs','tourplanImportOverride','posMasterDataOverride','decisions','task_pool'];

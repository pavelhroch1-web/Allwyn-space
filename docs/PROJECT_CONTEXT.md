...
- ~27 techniků napříč ČR, rozděleni do regionů (RSE, RSZ, RSJ, RSM, Praha)
- Demo/referenční technik v prototypu: **Lán Tomáš** (region RSE)
...
- **Filtr regionů** — RSE/RSZ/RSJ/RSM/Praha
